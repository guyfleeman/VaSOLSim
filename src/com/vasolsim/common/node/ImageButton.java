 ...
 * @author guyfleeman
 * @date 7/23/14
 * <p>This class wraps Button to provide functionality with images instead of text. Supports hover style. </p>
 */
public class ImageButton extends Button
{
	 ...
	 */
	public ImageButton(@NotNull Class loader,
	                   @NotNull String imageInternalURL,
