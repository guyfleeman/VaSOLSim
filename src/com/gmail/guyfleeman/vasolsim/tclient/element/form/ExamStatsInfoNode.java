 ...
 * <p></p>
 */
public class ExamStatsInfoNode implements DrawableNode
{
	public Exam lastGeneratedExam;

	protected Node examStatsInfoNode;

	public ExamStatsInfoNode()
	{
			...
			public void handle(MouseEvent mouseEvent)
			{
				...
				if (!foundError)
				{
					...
					else
					{
						...
						TeacherClient.examInfoNode.setExam(newExam.exam);
						TeacherClient.examInfoNode.boundTreeElement = newExam;
