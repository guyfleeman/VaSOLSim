 ...
 * @date 7/11/14 <p></p>
 */
public class __NONUSEDREFERENCE_OldExamBuilder
{
	/**
	 ...
	 */
	public static __NONUSEDREFERENCE_OldExamBuilder getInstance(String validationKey) throws VaSolSimException
	{
	 ...
	 * @throws VaSolSimException
	 */
	public static __NONUSEDREFERENCE_OldExamBuilder getInstance(byte[] key) throws VaSolSimException
	{
	    /*
		...
		return new __NONUSEDREFERENCE_OldExamBuilder(validate512HashTo128Hash(hash));
	}
	 ...
	 * @return
	 */
	public static __NONUSEDREFERENCE_OldExam getExamFromFile(File examFile, byte[] key)
	{
		return null;
	}

	public static boolean writeExamToFile(__NONUSEDREFERENCE_OldExam exam, File examFile, boolean canOverwriteFile) throws VaSolSimException
	{
		/*
		if (examFile.isFile())
		{
	...
	public static boolean writeExamToFile(__NONUSEDREFERENCE_OldExam exam, File examFile) throws VaSolSimException
	{
	...
	protected __NONUSEDREFERENCE_OldExamBuilder(byte[] validationHash) throws VaSolSimException
	{
		/*
	...
	public __NONUSEDREFERENCE_OldExam getExamFramework() throws VaSolSimException
	{
		/*
		 * Validate fields
		 */
		...
		return new __NONUSEDREFERENCE_OldExam(encryptedValidationHash,
		                parametricIV,
		                encryptionCipher,
		                decryptionCipher,
