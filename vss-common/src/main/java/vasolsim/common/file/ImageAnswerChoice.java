...
/**
 * @author willstuckey
 * @date 11/5/14 <p>This class represents a main.java.vasolsim.common.file.AnswerChoice but with an associated image. See the
...
public class ImageAnswerChoice extends AnswerChoice
{
	...
	/**
	 * Default constructor. Creates unlocked default main.java.vasolsim.common.file.AnswerChoice with a null image.
	 */
	...
	/**
	 * Default constructor. Creates unlocked default main.java.vasolsim.common.file.AnswerChoice with a given image.
	 *
	...
	/**
	 * Advanced constructor. Creates unlocked main.java.vasolsim.common.file.AnswerChoice with a given image.
